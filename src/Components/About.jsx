    ...
    return (
        <div id='about_main' className=' mx-5 my-16 w-[calc(100%-40px)] h-fit  bg-gray-50 dark:bg-gray-800 relative rounded-xl p-4'>
           <img src="/moshfequr.jpg" alt="myself" className='w-24 h-24 absolute -top-10 right-10 hover:scale-125 rounded-full' />
            ...
            <p className='dlsText'>BSc in <span className='bg-orange-100'> Electronics & communication Engineering (ECE) </span>  from Hajee Mohammad Danesh Science & Technology University (HSTU)
            </p>
           <div>
            ...
            <div  className='  md:flex-row md:gap-4 flex flex-col gap-2 justify-between mt-2'>
                <p className='dlxText rounded-full bg-emerald-100 md:bg-emerald-50  w-9 h-9 flex items-center justify-center font-bold'>1</p>
                <p className='dlxText md:basis-1/3  '><span className='bg-orange-100 p-[2px] '> React Next & Prisma</span></p>
